...
final class BluetoothSerial: NSObject {
    ...
    var serviceUUID = CBUUID(string: "2D7A9F0C-E0E8-4CC9-A71B-A21DB2D034A1")
    var serviceUUIDstr = "2D7A9F0C-E0E8-4CC9-A71B-A21DB2D034A1"

    // UUID of the characteristic to look for.
    var characteristicUUID = CBUUID(string: "82258BAA-DF72-47E8-99BC-B73D7ECD08A5")
